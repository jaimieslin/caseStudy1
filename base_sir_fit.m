...
covidstlcity_full = double(table2array(COVID_STLcity(:,[5:6])))./(100000*STLcityPop);
covidstlcnty_full = double(table2array(COVID_STLcnty(:,[5:6])))./(100000*STLcntyPop);
covidstlmetro_full = double(table2array(COVID_STLmetro(:,[5:6])))./(100000*(STLcityPop + STLcntyPop));
