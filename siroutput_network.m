...
function f = siroutput_network(x,t,data)
...
casesModel_2 = 1 - y(:, 5);
casesActual_2 = data(1:t, 3);
casesModel_3 = 1 - y(:, 9);
casesActual_3 = data(1:t, 5);
deathsModel_1 = y(:, 4);
deathsActual_1 = data(1:t, 2);
deathsModel_2 = y(:, 8);
deathsActual_2 = data(1:t, 4);
deathsModel_3 = y(:, 12);
deathsActual_3 = data(1:t, 6);
